...
<div class="col-12 col-xl-12">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Add Pinjaman</h5>
            <form class="row g-3" method="POST" action="{{ route('pinjaman.store') }}">
                @csrf
                {{-- <div class="col-md-4x">
                ...
                <div class="col-md-12">
                    <div class="d-md-flex d-grid align-items-center gap-3">
                        ...
                        <button type="submit" class="btn btn-grd-primary px-4"><a href="{{route('pinjaman.index')}}" class="text-white">Back</a></button>
                </div>
            </form>
        </div>
    </div>
