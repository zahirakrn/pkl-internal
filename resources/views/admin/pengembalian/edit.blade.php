 ...
 <div class="col-11 col-xl-11">
    <div class="card">
        <div class="card-body p-4">
            <h5 class="mb-4">Edit Pengembalian <b>{{$pengembalians->tanggal_pengembalian}}</b></h5>
            <form class="row g-3" method="POST" action="{{ route('pengembalian.update', $pengembalians->id) }}">
                @method('put')
                @csrf
                {{-- <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <label for="input16" class="form-label">Tanggal Pengembalian</label>
                    <div class="position-relative input-icon">
                        <input type="date" name="tanggal_pengembalian" class="form-control @error('tanggal_pengembalian') is-invalid @enderror" value="{{ old('tanggal_pengembalian') }}" id="input16" placeholder="tanggal_pengembalian" required>
                        <span class="position-absolute top-50 translate-middle-y"><i class="material-icons-outlined fs-5">email</i></span>
